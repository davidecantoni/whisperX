    ...
    if not no_align:
        ...
        for result, audio_path in tmp_results:
            ...
            if len(result["segments"]) > 0:
                ...
                result = align(result["segments"], None, None, input_audio, device, interpolate_method=interpolate_method, return_char_alignments=return_char_alignments, print_progress=print_progress)
